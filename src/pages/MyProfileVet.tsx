...
import { VeterinarianProfile, PortfolioItem } from '../types';
...
const PortfolioManager: React.FC<{
    ...
    return (
        <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            {items.length === 0 ? <p className="text-gray-500 dark:text-gray-400">Showcase your work by adding portfolio items.</p> : (
            ...
            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-6">My Profile</h1>
             <div className="space-y-8">
                <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md space-y-6">
                    <div>
                         <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4 border-b pb-2 dark:border-gray-700">Basic Information</h2>
                         ...
                         <Input as="textarea" label="Bio" name="bio" value={formData.bio} onChange={(e) => handleChange(e as React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>)} placeholder="Tell patients about yourself..." required minLength={20}/>
                    </div>

                    <div className="pt-4">
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4 border-b pb-2 dark:border-gray-700">Showcase Your Work</h2>
